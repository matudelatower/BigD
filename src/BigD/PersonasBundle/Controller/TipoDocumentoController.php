...
use BigD\PersonasBundle\Entity\TipoDocumento;
use BigD\PersonasBundle\Form\TipoDocumentoType;
...
class TipoDocumentoController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->get('session')->getFlashBag()->add(
                    'success', 'Tipo Documento Creado correctamente.'
            );
            
            return $this->redirect($this->generateUrl('tipo_documento_edit', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(TipoDocumento $entity)
    {
        $form = $this->createForm(new TipoDocumentoType(), $entity, array(
            'action' => $this->generateUrl('tipo_documento_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new TipoDocumentoType(), $entity, array(
            'action' => $this->generateUrl('tipo_documento_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            $em->flush();
            $this->get('session')->getFlashBag()->add(
                    'success', 'Tipo Documento Actualizado correctamente.'
            );

            return $this->redirect($this->generateUrl('tipo_documento_edit', array('id' => $id)));
        }
...
//            'delete_form' => $deleteForm->createView(),
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('tipo_documento'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('tipo_documento_delete', array('id' => $id)))
            ->setMethod('DELETE')
