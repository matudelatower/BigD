...
class ResultadoRespuestaRepository extends EntityRepository
{
    ...
    public function getMaximoRespuestaPorId($id)
    {
        ...
        $query = "SELECT
                     ...
                     campania_encuesta_resultado_cabecera.nro_cuestionario AS campania_encuesta_resultado_cabecera_nrocuestionario
                FROM
                ...
                GROUP BY
                     campania_encuesta_resultado_cabecera.nro_cuestionario
    ...
    public function getRespuestasPorPreguntaId($idPregunta)
    {
        ...
        $query = "SELECT
             campania_encuesta_resultado_respuesta.texto_respuesta AS texto_respuesta
        FROM
    ...
    public function getRespuestasPorAgrupadorId($idAgrupador, $idResultadoCabecera)
    {
        ...
        $query = "select agru.id,
                  pre.texto_pregunta,
                  res.texto_respuesta,
                  res.campania_encuesta_opcion_respuesta_id as id_opcion_respuesta,
                  agru.multiple,
