...
use BigD\CampaniasBundle\Entity\TipoPregunta;
use BigD\CampaniasBundle\Form\TipoPreguntaType;
...
class TipoPreguntaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CampaniasBundle:TipoPregunta')->findAll();
        ...
        return $this->render('CampaniasBundle:TipoPregunta:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        $form = $this->createForm(new TipoPreguntaType(), $entity);
        ...
        return $this->render('CampaniasBundle:TipoPregunta:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CampaniasBundle:TipoPregunta')->find($id);
        ...
        return $this->render('CampaniasBundle:TipoPregunta:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new TipoPreguntaType(), $entity);
        

        return $this->render('CampaniasBundle:TipoPregunta:edit.html.twig', array(
            'entity'      => $entity,
